<?php
/**
 * index.php — DISCOVER AND RE-WIND EVERYWHERE Home
 */
session_start();
?>
<!DOCTYPE html>
...
<title>DISCOVER AND RE-WIND EVERYWHERE — Vintage Finds, Verified Sellers</title>
...
<footer>
  &copy; <?= date('Y') ?> DISCOVER AND RE-WIND EVERYWHERE — WEDE6021 POE Project
