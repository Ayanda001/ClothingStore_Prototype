...
<title>ClothingStore — Vintage Finds, Verified Sellers</title>
...
<footer>
  &copy; <?= date('Y') ?> ClothingStore — WEDE6021 POE Project
  &nbsp;|&nbsp; <a href="admin/login.php" style="color:var(--muted)">Admin</a>
  &nbsp;|&nbsp; <a href="loadClothingStore.php" style="color:var(--muted)">Setup DB</a>
</footer>
</body>
</html>
